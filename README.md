...
| `config.session_redis_host`                 | `127.0.0.1`                                | false    | Redis host for session storage (if storage is redis).                                                                                                                                   |
| `config.session_redis_port`                 | `6379`                                     | false    | Redis port for session storage.                                                                                                                                                         |
| `config.session_redis_auth`                 |                                            | false    | Redis password/auth for session storage.                                                                                                                                                |
| `config.session_redis_ssl`                  | `false`                                    | false    | Enable SSL for Redis connection.                                                                                                                                                        |
| `config.session_redis_prefix`               | `sessions`                                 | false    | Prefix for Redis keys.                                                                                                                                                                  |
